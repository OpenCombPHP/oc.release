...
return \$__uivar_row->data('content');") ;?> <a href="?c=groups.thread.update&tid=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('tid');") ;?>">修改</a> <a href="?c=groups.thread.delete&tid=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
